...
-- CreateEnum
CREATE TYPE "public"."StatusAtribuicao" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED', 'CANCELLEND');

-- CreateEnum
CREATE TYPE "public"."RequestStatus" AS ENUM ('OPEN', 'ASSIGNED', 'CANCELLEND', 'DONE');
...
CREATE TABLE "public"."AtribuicaoServicos" (
    ...
    "status" "public"."StatusAtribuicao" NOT NULL DEFAULT 'PENDING',
...
-- AddForeignKey
ALTER TABLE "public"."AtribuicaoServicos" ADD CONSTRAINT "AtribuicaoServicos_serviceRequestId_fkey" FOREIGN KEY ("serviceRequestId") REFERENCES "public"."SolicitacaoServicos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Message" ADD CONSTRAINT "Message_serviceRequestId_fkey" FOREIGN KEY ("serviceRequestId") REFERENCES "public"."SolicitacaoServicos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Rating" ADD CONSTRAINT "Rating_serviceRequestId_fkey" FOREIGN KEY ("serviceRequestId") REFERENCES "public"."SolicitacaoServicos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
